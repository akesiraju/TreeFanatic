class VisualBinarySearchTree implements IBinarySearchTree
{
    Root: VisualTreeNode;
    private treeDesigner: TreeDesigner;
    ...
    constructor(_treeDesigner: TreeDesigner)
    {
        this.Root = null;
    ...
    private GetHeight(root: VisualTreeNode): number
    {
        if (root == null)
        {
            return 0;
    ...
    private GetDiameter(root: VisualTreeNode): number
    {
        if (root == null)
        {
            return 0;
